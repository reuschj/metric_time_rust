...
//!
//! ```
//! use metric_time::{Time, TimeComponents, TimeKind, TimeConversionTrait};
//!
...
impl Time {
    ...
    /// ⏱️ Creates a Time instance representing the current local time.
    ///
    /// # 🔄 Returns
...
/*
🧪 Tests --------------------------------------------------------------------------- /
Unit tests for Time implementation
*/
