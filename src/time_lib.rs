...
//!
//! ```
//! use metric_time::{TimeComponents, TimeKind, Period, TimeBounds, TimeRotationComponents};
//!
...
pub struct TimeComponents {
    pub hours: u8,        // 🕐 Hours component
    pub minutes: u8,      // ⏱️ Minutes component
    pub seconds: u8,      // ⏲️ Seconds component
    pub nanoseconds: u32, // ⚛️ Nanoseconds component
}
...
pub struct TimeRotationComponents {
    hours: f64,       // 🕐 Hours hand rotation in degrees
    minutes: f64,     // ⏱️ Minutes hand rotation in degrees
    seconds: f64,     // ⏲️ Seconds hand rotation in degrees
    nanoseconds: f64, // ⚛️ Nanoseconds hand rotation in degrees (theoretical)
}
...
mod tests {
    ...
    /// 🔟 Test for metric time bounds validation
    #[test]
    ...
    /// 🕛 Test for 12-hour time bounds validation
    #[test]
    ...
    /// 🕒 Test for 24-hour time bounds validation
    #[test]
    ...
    /// 📐 Test for clock hand rotation calculations in metric time
    #[test]
    fn it_calculates_clock_hand_rotations_in_metric() {
        let components = TimeComponents::new(2, 45, 23, 234_000_000);
        /// 🔢 Helper function to round floats for comparison
